    ...
    <div className="container-lg">
      ...
      <div className="Piecharts">
        <div className="Piechart1">
          <PieChart width={600} height={400} className="TableContainer">
            <Pie
              data={data}
              dataKey="value"
              nameKey="name"
        ...
        <div className="Piechart2">
          <BarChart width={700} height={400} data={data2} className="TableContainer">
            <XAxis dataKey="day" />
            <YAxis />
            <Tooltip />
            <Legend />
      ...
      <BarChart width={1300} height={400} data={data3} className="TableContainer">
